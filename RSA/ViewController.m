...
//  Copyright © 2016年 XK_RSA. All rights reserved.
//
...
- (void)viewDidLoad {
    ...
    [self StringTokeyToString];
    
//    [self KeyToStringToKey];
    
}


- (void)StringTokeyToString {
    //原始数据
    ...
    NSLog(@"解密后:%@", [RSAEncryptor decryptString:encryptStr privateKeyWithContentsOfFile:private_key_path password:@"0"]);
}


- (void)KeyToStringToKey {
    //原始数据
